        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComparedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductComparisons", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductComparisons_Products_Product1Id",
                        column: x => x.Product1Id,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductComparisons_Products_Product2Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductComparisons_Product1Id",
                table: "ProductComparisons",
                column: "Product1Id");

            migrationBuilder.CreateIndex(
                name: "IX_ProductComparisons_Product2Id",
                table: "ProductComparisons",
                column: "Product2Id");

            migrationBuilder.CreateIndex(
                name: "IX_ProductComparisons_UserId_Product1Id_Product2Id",
                table: "ProductComparisons",
                columns: new[] { "UserId", "Product1Id", "Product2Id" },
                unique: true);
